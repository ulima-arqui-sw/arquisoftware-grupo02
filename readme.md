...
Usabilidad       | ESC-04  | Primera vez entrando a la plataforma             | Estudiante nuevo                                              | Se registra en la plataforma e intenta explorarla                                                                      | Recursos de Orientación y Tutoriales                 | La plataforma debe proporcionar orientación clara y tutoriales para los estudiantes nuevos                                | Tasa de Abandono, Tiempo para Comenzar a Resolver Problemas
Usabilidad       | ESC-05  | Creación de problemas                               | Profesor                                                       | Crear tareas de programación para sus estudiantes                                                                       | Interfaz de Administración de Problemas                | Debe proporcionar una interfaz de administración de problemas intuitiva y fácil de usar para permitir que los profesores configuren tareas de programación de manera eficiente y sin dificultades innecesarias | Tiempo de Configuración de Tareas, Número de Pasos o Clics, Satisfacción del Profesor
Usabilidad       | ESC-06  | Estudiante se registra por primera vez           | Estudiante nuevo                                              | Intentar utilizar la plataforma para resolver problemas de práctica                                                      | Interfaz de Usuario                                  | Debe proporcionar una interfaz de usuario clara, organizada y fácil de usar para que los estudiantes nuevos puedan encontrar y utilizar las funciones básicas sin dificultades innecesarias | Tiempo de Acceso a Funciones Básicas, Número de Intentos para Realizar una Acción, Tasa de Abandono
Disponibilidad   | ESC-07  | Competencia importante de programación en línea con miles de participantes | Participantes en la competencia, administradores de la plataforma | La plataforma de juez en línea sufre un tiempo de inactividad no planificado debido a un error de servidor                  | Servidores de la Plataforma                           | La plataforma de juez en línea debe mantener una alta disponibilidad para garantizar que las competencias importantes y otras actividades no se vean interrumpidas por tiempos de inactividad inesperados | Número de Participantes Afectados, Duración del Tiempo de Inactividad
Disponibilidad   | ESC-08  | Un grupo de estudiantes de diferentes partes del mundo se está preparando para enviar sus soluciones a un problema importante justo antes de la fecha límite | Estudiantes participantes, administradores de la plataforma, proveedor de servicios de alojamiento | Enviar sus soluciones durante la competencia | Servicios de Alojamiento del Proveedor                  | Debe estar diseñada y configurada de manera que garantice una alta disponibilidad y evite interrupciones o fallas del proveedor de servicios de alojamiento durante competencias y eventos importantes | Tiempo de Disponibilidad, Registro de Interrupciones
Disponibilidad   | ESC-09  | Durante una competencia internacional de programación en línea con equipos de todo el mundo | Personal de mantenimiento del centro de datos | Un corte de energía inesperado afecta al centro de datos que aloja la plataforma de juez en línea | Infraestructura del Centro de Datos                  | La plataforma de juez en línea debe estar diseñada para mantener la disponibilidad incluso en situaciones de interrupción, como cortes de energía, mediante medidas de redundancia y sistemas de respaldo adecuados | Duración de la Interrupción, Número de Competidores Afectados
Rendimiento      | ESC-10  | Un equipo de programadores participa en una competencia internacional en línea | Programadores participantes                                     | Los programadores se enfrentan a problemas altamente complejos que requieren una gran carga computacional para su evaluación     | Sistema de Evaluación de Soluciones                    | Debe estar diseñada y configurada para manejar eficientemente la carga computacional requerida para evaluar soluciones complejas durante competencias, sin ralentizar drásticamente el proceso ni afectar negativamente la calidad de la experiencia de los participantes | Tiempo de Evaluación, Uso de Recursos del Servidor
Rendimiento      | ESC-11  | Competencia de programación                       | Competidores                                                    | Envía una solución que contiene un error de programación que resulta en un bucle infinito                                       | Sistema de Evaluación de Soluciones                    | Debe estar diseñada para detectar y manejar adecuadamente situaciones de bucle infinito en las soluciones de los usuarios, evitando así un impacto grave en el rendimiento y retrasos para otros competidores | Tiempo de Ejecución, Recursos Consumidos, Número de Soluciones con Bucle Infinito
Rendimiento      | ESC-12  | Competencia en línea de programación              | Estudiante                                                      | Envía una solución que, aunque correcta, contiene un algoritmo ineficiente que requiere mucho tiempo para su evaluación      | Sistema de Evaluación de Soluciones                    | Debe ser capaz de detectar soluciones ineficientes y manejarlas adecuadamente para evitar que afecten negativamente el rendimiento y causen retrasos para otros participantes | Tiempo de Evaluación, Recursos Consumidos, Número de Soluciones Ineficientes
